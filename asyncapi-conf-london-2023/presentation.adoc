...
== Demo
image::architecture.png[width=600,height=600]
 +
 +
...
- To be a good citizen we should give back to the community, it can be a PR, a blog post, a talk, a bug report, anything that will make the AsyncAPI and its ecosystem better.
--
